...
HEADERS += src/activemasternode.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/avianitecoin-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/avianitecoin-cli.cpp \
           src/avianitecoin-tx.cpp \
           src/avianitecoin.cpp \
           src/db.cpp \
...
RESOURCES += src/qt/avianitecoin.qrc src/qt/avianitecoin_locale.qrc

TRANSLATIONS += src/qt/locale/avianitecoin_bg.ts \
                src/qt/locale/avianitecoin_de.ts \
                src/qt/locale/avianitecoin_en.ts \
                src/qt/locale/avianitecoin_es.ts \
                src/qt/locale/avianitecoin_fi.ts \
                src/qt/locale/avianitecoin_fr.ts \
                src/qt/locale/avianitecoin_it.ts \
                src/qt/locale/avianitecoin_ja.ts \
                src/qt/locale/avianitecoin_pl.ts \
                src/qt/locale/avianitecoin_pt.ts \
                src/qt/locale/avianitecoin_ru.ts \
                src/qt/locale/avianitecoin_sk.ts \
                src/qt/locale/avianitecoin_sv.ts \
                src/qt/locale/avianitecoin_vi.ts \
                src/qt/locale/avianitecoin_zh_CN.ts \
                src/qt/locale/avianitecoin_zh_TW.ts
