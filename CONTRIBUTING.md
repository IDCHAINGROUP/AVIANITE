Contributing to avianitecoin
============================

The avianitecoin project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/avianitecoinvps-project/avianitecoin/blob/master/doc/translation_process.md)
...
The following applies to code changes to the avianitecoin project, and is not to be
confused with overall avianitecoin Network Protocol consensus changes.

Whether a pull request is merged into avianitecoin rests with the project merge
...
Patches that change avianitecoin consensus rules are considerably more involved than
...
Where a patchset proposes to change the avianitecoin consensus, it must have been
...
The project leader is the release manager for each avianitecoin release.
