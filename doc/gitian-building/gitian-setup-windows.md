...
The build script we'll be using is contained in the avianitecoin github repository ([contrib/gitian-build.py](https://github.com/avianitecoinvps-project/avianitecoin/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the avianitecoin repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/avianitecoinvps-project/avianitecoin/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, avianitecoin-detached-sigs, and avianitecoin GitHub repos.
