...
The script [extract-osx-sdk.sh](https://github.com/avianitecoinvps-project/avianitecoin/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
avianitecoin/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/avianitecoinvps-project/avianitecoin/blob/master/doc/README_osx.md) for troubleshooting tips.
