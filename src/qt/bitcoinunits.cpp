...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(AVIAN);
    unitlist.append(mAVIAN);
    unitlist.append(uAVIAN);
    return unitlist;
}
...
QString BitcoinUnits::id(int unit)
{
    switch (unit) {
    case AVIAN:
        return QString("avianitecoin");
    case mAVIAN:
        return QString("mavianitecoin");
    case uAVIAN:
        return QString::fromUtf8("uavianitecoin");
    default:
        return QString("???");
    }
}
