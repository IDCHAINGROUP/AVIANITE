...
/* avianitecoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Avianitecoin"
#define QAPP_ORG_DOMAIN "avianitecoin.trade"
#define QAPP_APP_NAME_DEFAULT "Avianitecoin-Qt"
#define QAPP_APP_NAME_TESTNET "Avianitecoin-Qt-testnet"
