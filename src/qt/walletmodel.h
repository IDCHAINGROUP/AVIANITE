...
#ifndef avianitecoin_QT_WALLETMODEL_H
#define avianitecoin_QT_WALLETMODEL_H
...
/** Interface to avianitecoin wallet from Qt view code. */
...
#endif // avianitecoin_QT_WALLETMODEL_H
