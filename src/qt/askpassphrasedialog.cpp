...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            avianitecoinGUI* window = static_cast<avianitecoinGUI*>(parentWidget());
...
{
    avianitecoinGUI* gui = static_cast<avianitecoinGUI*>(parentWidget());
...
{
    hide();
    static_cast<avianitecoinGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("Avianitecoin will close now to finish the encryption process. "
               "Remember that encrypting your wallet cannot fully protect "
               "your AVIANs from being stolen by malware infecting your computer.") +
            "<br><br><b>" +
