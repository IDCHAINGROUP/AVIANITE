...
/** Utility functions used by the avianitecoin Qt UI.
 */
namespace GUIUtil
{
...
// Render avianitecoin addresses in monospace font
...
// Parse "avianitecoin:" URI into recipient object, return true on successful parsing
