...
bool openDialogWithOpaqueBackgroundY(QDialog* widget, avianitecoinGUI* gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog* widget, avianitecoinGUI* gui, double posX = 3);
