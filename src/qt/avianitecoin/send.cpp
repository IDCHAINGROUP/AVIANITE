...
#include "qt/avianitecoin/forms/ui_send.h"
#include "qt/avianitecoin/addnewcontactdialog.h"
#include "qt/avianitecoin/qtutils.h"
#include "qt/avianitecoin/sendchangeaddressdialog.h"
#include "qt/avianitecoin/optionbutton.h"
#include "qt/avianitecoin/sendconfirmdialog.h"
#include "qt/avianitecoin/myaddressrow.h"
#include "qt/avianitecoin/guitransactionsutils.h"
...
SendWidget::SendWidget(avianitecoinGUI* parent) :
    PWidget(parent),
    ui(new Ui::send),
    ...
    btnContacts(new QPushButton())
{
    ...
    setCssProperty(coinIcon, "coin-icon-avianitecoin");
...
void SendWidget::onContactMultiClicked()
{
    if (focusedEntry) {
        ...
        CTxDestination avianitecoinAdd = DecodeDestination(address.toStdString());
        if (walletModel->isMine(avianitecoinAdd)) {
        ...
        if (dialog->res) {
            ...
            if (walletModel->updateAddressBookLabels(avianitecoinAdd, dialog->getLabel().toStdString(),
                    AddressBook::AddressBookPurpose::SEND)) {
