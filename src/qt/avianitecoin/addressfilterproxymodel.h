...
#ifndef avianitecoin_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define avianitecoin_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //avianitecoin_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
