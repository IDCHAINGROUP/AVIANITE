...
#include "qt/avianitecoin/forms/ui_masternodeswidget.h"

#include "qt/avianitecoin/qtutils.h"
#include "qt/avianitecoin/mnrow.h"
#include "qt/avianitecoin/mninfodialog.h"
#include "qt/avianitecoin/masternodewizarddialog.h"
...
MasterNodesWidget::MasterNodesWidget(avianitecoinGUI *parent) :
    PWidget(parent),
...
void MasterNodesWidget::onCreateMNClicked()
{
    ...
    if (walletModel->getBalance() <= GetMNCollateral(chainActive.Height()) * COIN) {
        inform(tr("Not enough balance to create a masternode, %1 AVIAN required.").arg(GetMNCollateral(chainActive.Height())));
        return;
    }
    showHideOp(true);
