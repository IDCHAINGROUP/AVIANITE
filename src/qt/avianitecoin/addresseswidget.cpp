...
#include "qt/avianitecoin/forms/ui_addresseswidget.h"
#include "qt/avianitecoin/addresslabelrow.h"
#include "qt/avianitecoin/addnewaddressdialog.h"
#include "qt/avianitecoin/tooltipmenu.h"
...
AddressesWidget::AddressesWidget(avianitecoinGUI* parent) :
    PWidget(parent),
...
void AddressesWidget::onStoreContactClicked()
{
    if (walletModel) {
        ...
        CTxDestination avianitecoinAdd = DecodeDestination(address.toUtf8().constData(), isStakingAddress);
        ...
        if (walletModel->updateAddressBookLabels(avianitecoinAdd, label.toUtf8().constData(),
