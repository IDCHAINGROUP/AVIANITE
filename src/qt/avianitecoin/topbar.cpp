...
#include "qt/avianitecoin/topbar.h"
#include "qt/avianitecoin/forms/ui_topbar.h"
#include "qt/avianitecoin/lockunlock.h"
#include "qt/avianitecoin/qtutils.h"
#include "qt/avianitecoin/receivedialog.h"
#include "qt/avianitecoin/loadingdialog.h"
...
TopBar::TopBar(avianitecoinGUI* _mainWindow, QWidget *parent) :
    ...
    ui(new Ui::TopBar)
{
    ...
    setCssProperty({ui->labelAmountTopAVIAN}, "amount-small-topbar");
    setCssProperty({ui->labelAmountAVIAN}, "amount-topbar");
    setCssProperty({ui->labelPendingAVIAN, ui->labelImmatureAVIAN}, "amount-small-topbar");
...
void TopBar::loadWalletModel()
{
    ...
    // update the display unit, to not use the default ("avianitecoin")
    updateDisplayUnit();
                            ...
                            const CAmount& delegatedBalance, const CAmount& coldStakedBalance)
{
    ...
    // AVIAN Total
    QString totalAVIAN = GUIUtil::formatBalance(balance, nDisplayUnit);

    // AVIAN
    // Top
    ui->labelAmountTopAVIAN->setText(totalAVIAN);
    // Expanded
    ui->labelAmountAVIAN->setText(totalAVIAN);
    ui->labelPendingAVIAN->setText(GUIUtil::formatBalance(unconfirmedBalance, nDisplayUnit));
    ui->labelImmatureAVIAN->setText(GUIUtil::formatBalance(immatureBalance, nDisplayUnit));
}
