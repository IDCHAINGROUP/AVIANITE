...
#include <QWidget>
#include <QString>
#include "qt/avianitecoin/prunnable.h"
...
class PWidget : public QWidget, public Runnable, public Translator
{
    Q_OBJECT
public:
    explicit PWidget(avianitecoinGUI* _window = nullptr, QWidget *parent = nullptr);
    explicit PWidget(PWidget *parent = nullptr);

    void setClientModel(ClientModel* model);
    void setWalletModel(WalletModel* model);

    avianitecoinGUI* getWindow() { return this->window; }
...
protected:
    avianitecoinGUI* window = nullptr;
