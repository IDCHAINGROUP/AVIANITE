...
#include "qt/avianitecoin/txviewholder.h"
#include "qt/avianitecoin/tooltipmenu.h"
#include "qt/avianitecoin/sendmultirow.h"
#include "qt/avianitecoin/coldstakingmodel.h"
#include "qt/avianitecoin/contactsdropdown.h"
...
public:
    explicit ColdStakingWidget(avianitecoinGUI* parent);
    ~ColdStakingWidget();
