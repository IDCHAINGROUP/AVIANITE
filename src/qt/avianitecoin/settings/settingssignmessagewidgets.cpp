...
#include "qt/avianitecoin/settings/forms/ui_settingssignmessagewidgets.h"
...
SettingsSignMessageWidgets::SettingsSignMessageWidgets(avianitecoinGUI* _window, QWidget *parent) :
