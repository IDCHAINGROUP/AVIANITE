...
#include "qt/avianitecoin/settings/forms/ui_settingsexportcsv.h"
#include <QFile>
...
SettingsExportCSV::SettingsExportCSV(avianitecoinGUI* _window, QWidget *parent) :
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
                                        ...
                                        isTxExport ? tr("avianitecoin_tx_csv_export(*.csv)") : tr("avianitecoin_addresses_csv_export(*.csv)"),
                                        nullptr);
