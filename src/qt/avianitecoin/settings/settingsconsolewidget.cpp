...
#include "qt/avianitecoin/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/avianitecoin/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(avianitecoinGUI* _window, QWidget *parent) :
...
void SettingsConsoleWidget::clear(bool clearHistory)
{
	...
	message(CMD_REPLY, (tr("Welcome to the Avianitecoin RPC console.") + "<br>" +
