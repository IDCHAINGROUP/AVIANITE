...
#include "qt/avianitecoin/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/avianitecoin/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(avianitecoinGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to avianitecoinGUI::handleRestart()
