...
#include "qt/avianitecoin/settings/forms/ui_settingsfaqwidget.h"
#include <QScrollBar>
#include <QMetaObject>
#include "qt/avianitecoin/qtutils.h"

SettingsFaqWidget::SettingsFaqWidget(avianitecoinGUI *parent) :
    QDialog(parent),
    ui(new Ui::SettingsFaqWidget)
{
    ...
    setCssProperty({
           ...
           ui->labelNumber_UnspendableAVIAN,
    ...
    setCssProperty({
              ...
              ui->labelSubtitle_UnspendableAVIAN,
    ...
    setCssProperty({
              ...
              ui->labelContent_UnspendableAVIAN,
    ...
    setCssProperty({
              ui->pushButton_Intro,
              ui->pushButton_UnspendableAVIAN,
              ui->pushButton_Stake,
    ...
    connect(ui->pushButton_UnspendableAVIAN, &QPushButton::clicked, [this](){onFaqClicked(ui->widget_UnspendableAVIAN);});
    ...
    if (parent)
        connect(parent, &avianitecoinGUI::windowResizeEvent, this, &SettingsFaqWidget::windowResizeEvent);
}
