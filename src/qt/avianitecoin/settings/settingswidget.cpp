...
#include "qt/avianitecoin/settings/forms/ui_settingswidget.h"
...
SettingsWidget::SettingsWidget(avianitecoinGUI* parent) :
    PWidget(parent),
    ui(new Ui::SettingsWidget)
{
    ...
    connect(ui->pushButtonHelp1, &QPushButton::clicked, window, &avianitecoinGUI::openFAQ);
