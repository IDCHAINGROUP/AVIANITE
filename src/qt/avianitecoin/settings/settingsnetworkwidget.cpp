...
#include "qt/avianitecoin/settings/settingsnetworkwidget.h"
#include "qt/avianitecoin/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/avianitecoin/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(avianitecoinGUI* _window, QWidget *parent) :
