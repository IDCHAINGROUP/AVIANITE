...
#include "qt/avianitecoin/sendcustomfeedialog.h"
#include "qt/avianitecoin/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(avianitecoinGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &avianitecoinGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
