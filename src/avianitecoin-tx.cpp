...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("avianitecoin avianitecoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  avianitecoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded avianitecoin transaction") + "\n" +
                               "  avianitecoin-tx [options] -create [commands]   " + _("Create hex-encoded avianitecoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded avianitecoin transaction
