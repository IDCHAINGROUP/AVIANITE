...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw std::runtime_error(
            "stop\n"
            "\nStop Avianitecoin server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "Avianitecoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* avianitecoin features */
        {"avianitecoin", "listmasternodes", &listmasternodes, true, true, false},
        {"avianitecoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"avianitecoin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"avianitecoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"avianitecoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"avianitecoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"avianitecoin", "masternodedebug", &masternodedebug, true, true, false},
        {"avianitecoin", "startmasternode", &startmasternode, true, true, false},
        {"avianitecoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"avianitecoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"avianitecoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"avianitecoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"avianitecoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"avianitecoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"avianitecoin", "preparebudget", &preparebudget, true, true, false},
        {"avianitecoin", "submitbudget", &submitbudget, true, true, false},
        {"avianitecoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"avianitecoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"avianitecoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"avianitecoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"avianitecoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"avianitecoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"avianitecoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"avianitecoin", "checkbudgets", &checkbudgets, true, true, false},
        {"avianitecoin", "mnsync", &mnsync, true, true, false},
        {"avianitecoin", "spork", &spork, true, true, false},
...
{
    return "> avianitecoin-cli " + methodname + " " + args + "\n";
}
